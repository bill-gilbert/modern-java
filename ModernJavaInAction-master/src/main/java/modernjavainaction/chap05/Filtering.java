...
public class Filtering {
    ...
    public static void main(String... args) {
        ...
        List<Dish> specialMenu = Arrays.asList(
                ...
                new Dish("pork", false, 530, Dish.Type.MEAT),
                new Dish("bisquit", true, 130, Dish.Type.OTHER),
                new Dish("bred", true, 230, Dish.Type.OTHER),
                new Dish("tune", false, 30, Dish.Type.FISH));
        ...
        filteredMenu.sort(Comparator.comparingInt(Dish::getCalories));
